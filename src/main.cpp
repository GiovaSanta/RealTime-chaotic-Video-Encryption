...
int main () {
    ...
    std::cout << "Max grid dimensions: (" << maxGridDimX << ", "
              << maxGridDimY << ", " << maxGridDimZ << ")" << std::endl;
    ...
    int numKeys =128 * 3 ;  /* each iteration of the PRBG main is a resultant input seed...
    ...
    std::vector<unsigned char> buffer(width * height * 3); // considering the rgb image , the image information is thrice that of the greyscale
