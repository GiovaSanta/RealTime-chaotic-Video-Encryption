...
int main(int argc, char** argv) {
    ...
    //std::string inputPath     = "testVideos/960x960_24fps.mp4";
    //std::string inputPath     = "testVideos/768x768_20fps.mp4";
    //std::string inputPath     = "testVideos/672x672_20fps.mp4";
    //std::string inputPath     = "testVideos/672x672_24fps.mp4";
    //std::string inputPath     = "testVideos/576x576_20fps.mp4";
    //std::string inputPath     = "testVideos/576x576_24fps.mp4";
    //std::string inputPath     = "testVideos/480x480_20fps.mp4";
    //std::string inputPath     = "testVideos/480x480_24fps.mp4";
    //std::string inputPath     = "testVideos/384x384_20fps.mp4";
    //std::string inputPath     = "testVideos/384x384_24fps.mp4";
    //std::string inputPath     = "testVideos/288x288_20fps.mp4";
    //std::string inputPath     = "testVideos/288x288_24fps.mp4";
    //std::string inputPath       = "testVideos/192x192_20fps.mp4";
    //std::string inputPath       = "testVideos/192x192_24fps.mp4";
    ...
    std::string pipeline_enc =
        ...
        ",height=" + std::to_string(height) +
        ",framerate=" + std::to_string(fps) + "/1 ! "
        "nvv4l2h264enc bitrate=500000 insert-sps-pps=true iframeinterval=30 ! "
...
void encrypt_thread() {
    ...
    while (true) {
        ...
        auto startEnct0 = std::chrono::high_resolution_clock::now();
        ...
        if (frameCount >= 1) {
            ...
            float enc_ms = 0.0f;
            CHECK_CUDA(cudaEventElapsedTime(&enc_ms, encStart[prev], encStop[prev]), "cudaEventElapsedTime(prev enc)") ;
        ...
        // invert rounds (DIFFUSION inverse first, then CONFUSION inverse)
        invConf = 1;
        invDiff = 1;
        ...
        // for correctness checking, sync here
    ...
    if( enc_measured_frames > 0) {
        ...
        std::cout << "Avf theoretical FPS : " << ((1000.0)/enc_avg_ms) << "\n\n" ;
    }
    ...
    if (frameCount > 0) {
        ...
        float enc_ms = 0.0f ; 
        CHECK_CUDA(cudaEventElapsedTime(&enc_ms, encStart[last], encStop[last]), "cudaEventElapsedTime(last enc)") ;
